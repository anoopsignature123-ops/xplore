         ...
         <div class="col-sm-12">
            <div class="card shadow-lg border-0 rounded-3">
               <div class="card-header bg-light py-3 d-flex justify-content-between align-items-center">
                  <h5 class="mb-0 fw-bold text-primary"><i class="fas fa-envelope-open-text me-2"></i> <?php echo e($page_title); ?></h5>
               </div>
               <div class="card-body">
...
$(document).ready(function() {
    var table = $('#builder-inquiries-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('builder.inquiry.getRecords')); ?>",
            data: function(d) {
    ...
    $(document).on('change', '.status-select', function() {
        ...
        var status = $(this).val();
        $.ajax({
            url: "<?php echo e(route('builder.inquiry.updateStatus')); ?>",
            type: "POST",
...
<?php echo $__env->make('builder.includes.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\xplore-22-09-26\resources\views/builder/inquiry/list.blade.php ENDPATH**/ ?>