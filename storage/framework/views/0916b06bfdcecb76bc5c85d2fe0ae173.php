            ...
            <div class="card shadow-lg border-0 rounded-3"> 
               ...
               <div class="card-body p-4">
                  <form id="saveForm" class="theme-form row g-3" enctype="multipart/form-data">
                     <input type="hidden" name="id" id="id" value="<?php echo e($settings->id ?? ''); ?>">
                     <input type="hidden" name="old_logo" id="old_logo" value="<?php echo e($settings->logo ?? ''); ?>">
                     <input type="hidden" name="old_favicon" id="old_favicon" value="<?php echo e($settings->favicon ?? ''); ?>">
                     <?php echo csrf_field(); ?>
                     ...
                     <div class="col-12 col-md-4">
                        ...
                        <input type="email" class="form-control" id="email_id" name="email_id"
                           value="<?php echo e($settings->email_id ?? ''); ?>" placeholder="Enter email">
                     </div>
                     <div class="col-12 col-md-4">
                        ...
                        <input type="text" class="form-control numberInput" id="phone_no" name="phone_no" minlength="10" maxlength="10"
                           value="<?php echo e($settings->phone_no ?? ''); ?>" placeholder="Enter phone number">
                     </div>
                     <div class="col-12 col-md-4">
                        ...
                        <input type="text" class="form-control numberInput" id="whatsapp_no" name="whatsapp_no" name="phone_no" minlength="10" maxlength="10"
                           value="<?php echo e($settings->whatsapp_no ?? ''); ?>" placeholder="Enter WhatsApp number">
                     </div>
                     <div class="col-12 col-md-4">
                        ...
                        <input type="url" class="form-control" id="facebook_link" name="facebook_link"
                           value="<?php echo e($settings->facebook_link ?? ''); ?>" placeholder="Facebook link">
                     </div>
                     <div class="col-12 col-md-4">
                        ...
                        <input type="url" class="form-control" id="instagram_link" name="instagram_link"
                           value="<?php echo e($settings->instagram_link ?? ''); ?>" placeholder="Instagram link">
                     </div>
                     <div class="col-12 col-md-4">
                        ...
                        <input type="url" class="form-control" id="twitter_link" name="twitter_link"
                           value="<?php echo e($settings->twitter_link ?? ''); ?>" placeholder="Twitter link">
                     </div>
                     <div class="col-12 col-md-4">
                        ...
                        <input type="url" class="form-control" id="youtube_link" name="youtube_link"
                           value="<?php echo e($settings->youtube_link ?? ''); ?>" placeholder="Youtube link">
                     </div>
                     <div class="col-12">
                        <label class="form-label" for="address">Address</label>
                        <textarea class="form-control" id="address" name="address" rows="1"
                           placeholder="Enter address"><?php echo e($settings->address ?? ''); ?></textarea>
                     </div>
                     <div class="col-12"> 
                        <label class="form-label" for="copyright">Copyright</label>
                        <input type="text" class="form-control" id="copyright" name="copyright"
                           value="<?php echo e($settings->copyright ?? ''); ?>" placeholder="© Your Company">
                     </div>
                     <div class="col-12 col-md-4">
                        ...
                        <div class="mt-2">
                           <div class="mt-3">
                              <a href="<?php echo e(!empty($settings->logo) ? asset($settings->logo) : ''); ?>" target="_blank">
                              <img id="logoPreview"
                                 src="<?php echo e(!empty($settings->logo) ? asset($settings->logo) : ''); ?>"
                                 alt="Image"
                                 class="img-thumbnail border rounded shadow-sm p-1"
                                 style="max-height: 100px; <?php echo e(empty($settings->logo) ? 'display:none;' : ''); ?>">
                              </a>
                           </div>
                        </div>
                     </div>
                     <div class="col-12 col-md-4">
                        ...
                        <div class="mt-2">
                           <div class="mt-3">
                              <a href="<?php echo e(!empty($settings->favicon) ? asset($settings->favicon) : ''); ?>" target="_blank">
                              <img id="faviconPreview"
                                 src="<?php echo e(!empty($settings->favicon) ? asset($settings->favicon) : ''); ?>"
                                 alt="Image"
                                 class="img-thumbnail border rounded shadow-sm p-1"
                                 style="max-height: 100px; <?php echo e(empty($settings->favicon) ? 'display:none;' : ''); ?>">
                              </a>
                           </div>
                        </div>
                     </div>
...
<script>
   $(document).ready(function () {
       $('#saveForm').on('submit', function(e){
           ...
           $.ajax({
               url: '<?php echo e(route("admin.websettings.save")); ?>',
               type: 'POST',
               data: formData,
               processData: false,
               contentType: false,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.includes.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\xplore-22-09-26\resources\views/admin/settings/settings.blade.php ENDPATH**/ ?>