    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">   
      <header class="page-header row">
        <div class="logo-wrapper d-flex align-items-center col-auto">
          <a href="<?php echo e(route('builder.index')); ?>" class="d-flex align-items-center me-2 text-decoration-none">	
            <img class="light-logo img-fluid" src="<?php echo e(!empty($settings->logo) ? asset($settings->logo) : ''); ?>" alt="<?php echo e($settings->company_name ?? ''); ?>" style="width:auto;height:50px;">
            <img class="dark-logo img-fluid" src="<?php echo e(!empty($settings->logo) ? asset($settings->logo) : ''); ?>" alt="<?php echo e($settings->company_name ?? ''); ?>" style="width:auto;height:50px;">
          </a>
