...
$(document).ready(function() {
    var table = $('#inquiries-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('admin.build-inquiry.getRecords')); ?>",
            data: function(d) {
    ...
    $(document).on('change', '.status-select', function() {
        ...
        var status = $(this).val();
        $.ajax({
            url: "<?php echo e(route('admin.build-inquiry.updateStatus')); ?>",
            type: "POST",
...
<?php echo $__env->make('admin.includes.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\xplore-22-09-26\resources\views/admin/builder_inquiry/list.blade.php ENDPATH**/ ?>