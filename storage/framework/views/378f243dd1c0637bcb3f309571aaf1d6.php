                        ...
                        <div class="row g-3 align-items-end">
                           ...
                           <div class="col-12 col-md-6 col-lg-4">
                              ...
                              <select class="form-select select2" id="filter_status">
                                 ...
                                 <option value="success" <?php echo e((isset($status) && $status == 'success') ? 'selected' : ''); ?>>Success</option>
                                 <option value="failed" <?php echo e((isset($status) && $status == 'failed') ? 'selected' : ''); ?>>Failed</option>
                              </select>
                           </div>
                           <div class="col-12 col-md-6 col-lg-4">
...
$(document).ready(function () {
   ...
   var table = $('#myTable').DataTable({
      ...
      ajax: {
         url: "<?php echo e(route('admin.transaction.getRecords')); ?>",
         data: function (d) {
      ...
      columns: [
         ...
         { data: 'txn_for', name: 'txn_for', title: 'Txn For' },
         { data: 'order_code', name: 'order_code', title: 'Order Code' },
         { data: 'razorpay_order_id', name: 'razorpay_order_id', title: 'Razorpay Order ID' },
         { data: 'transaction_id', name: 'transaction_id', title: 'Transaction ID' },
         { data: 'razorpay_payment_id', name: 'razorpay_payment_id', title: 'Razorpay Payment ID' },
         { data: 'amount', name: 'amount', title: 'Amount' },
         { data: 'status', name: 'status', title: 'Status' },
         { data: 'final_status', name: 'final_status', title: 'Final Status' },
...
<?php echo $__env->make('admin.includes.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\xplore-22-09-26\resources\views/admin/transaction/list.blade.php ENDPATH**/ ?>