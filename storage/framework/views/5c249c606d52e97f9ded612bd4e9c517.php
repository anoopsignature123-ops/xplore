            ...
            <div class="card shadow-lg border-0 rounded-3">
               ...
               <div class="card-header bg-light border-bottom-0 py-3 d-flex justify-content-between align-items-center rounded-top">
                  ...
                  <div class="d-flex gap-2">
                     ...
                     <a href="<?php echo e(route('admin.slider.add')); ?>" class="btn btn-outline-primary btn-sm">
...
<script type="text/javascript">
   $(document).ready(function() {
       var table = $('#myTable').DataTable({
           ...
           searching: true,
           ajax: {
               url: "<?php echo e(route('admin.slider.getRecords')); ?>",
               data: function (d) {
           ...
           columns: [
               ...
               { data: 'type', name: 'type', title: 'Slider Type' },
...
<script>
   ...
   $('#myTable').on('change', '.toggleStatus', function() {
      ...
      $.ajax({
          url: "<?php echo e(route('admin.slider.changeStatus')); ?>",
          type: "POST",
          data: {
   ...
   confirmDelete(function() {
       $.ajax({
           url: "<?php echo e(route('admin.slider.delete')); ?>",
           type: "POST",
           data: {
               id: id,
               _token: "<?php echo e(csrf_token()); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.includes.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\xplore-22-09-26\resources\views/admin/slider/list.blade.php ENDPATH**/ ?>