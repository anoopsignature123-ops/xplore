   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-md-6 footer-copyright">
            <p class="mb-0">Copyright <?php echo e(date('Y')); ?> © <?php echo e($settings->company_name ?? ''); ?></p>
         </div>
         <div class="col-md-6">
...
<!-- Feather Icons -->
<script src="<?php echo e(asset('assets/admin/js/vendors/feather-icon/feather.min.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/admin/js/vendors/feather-icon/custom-script.js')); ?>" defer></script>
<!-- Sidebar -->
...
<script src="<?php echo e(asset('assets/admin/js/slick/slick.min.js')); ?>" defer></script>
<!-- Tilt Animation -->
<script src="<?php echo e(asset('assets/admin/js/animation/tilt/tilt.jquery.js')); ?>" defer></script>
<script src="<?php echo e(asset('assets/admin/js/animation/tilt/tilt-custom.js')); ?>" defer></script>
<!-- Custom Script -->
...
<script>
   function previewImage(input, previewId) {
     ...
     if (file) {
       ...
       preview.src = '<?php echo e(!empty($cms->image) ? asset($cms->image) : ''); ?>';
...
</html><?php /**PATH C:\xampp\htdocs\xplore-22-09-26\resources\views/admin/includes/footer.blade.php ENDPATH**/ ?>