      ...
      <div class="row g-4">
         ...
         <div class="col-md-8">
            <div class="card shadow-sm border-0 rounded-3 mb-4">
               ...
               <div class="card-body">
                  <form action="{{ route('builder.profile.save') }}" method="POST" enctype="multipart/form-data">
                     @csrf
                     <div class="row g-3">
                        <div class="col-md-6">
                           ...
                           <input type="text" name="firm_name" class="form-control" value="{{ old('firm_name', $builder->firm_name) }}" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                           ...
                           <input type="text" name="location" class="form-control" value="{{ old('location', $builder->location) }}" required>
                        </div>

                        <div class="col-md-6">
                           <label class="form-label fw-bold"><i class="fas fa-briefcase text-primary me-1"></i> Experience (Years)</label>
                           <input type="number" name="experience_years" class="form-control" value="{{ old('experience_years', $builder->experience_years) }}">
                        </div>
                        <div class="col-md-6">
                           <label class="form-label fw-bold"><i class="fas fa-trophy text-primary me-1"></i> Completed Projects Count</label>
                           <input type="number" name="projects_count" class="form-control" value="{{ old('projects_count', $builder->projects_count) }}">
                        </div>
                        ...
                        <div class="col-md-6">
                           ...
                           <input type="text" name="address" class="form-control" value="{{ old('address', $builder->address) }}">
                        </div>
                        ...
                        <div class="col-12">
                           ...
                           <textarea name="about" class="form-control" rows="3">{{ old('about', $builder->about) }}</textarea>
                        </div>

                        <div class="col-md-4">
                           <label class="form-label fw-bold"><i class="fas fa-concierge-bell text-primary me-1"></i> Services Offered (Comma Separated)</label>
                           <input type="text" name="services" class="form-control" value="{{ implode(', ', $builder->services->pluck('service_name')->toArray()) }}">
                        </div>
                        <div class="col-md-4">
                           <label class="form-label fw-bold"><i class="fas fa-award text-primary me-1"></i> Certifications (Comma Separated)</label>
                           <input type="text" name="certifications" class="form-control" value="{{ implode(', ', $builder->certifications->pluck('certification_name')->toArray()) }}">
                        </div>
                        <div class="col-md-4">
                           <label class="form-label fw-bold"><i class="fas fa-map-marked-alt text-primary me-1"></i> Service Areas (Comma Separated)</label>
                           <input type="text" name="service_areas" class="form-control" value="{{ implode(', ', $builder->serviceAreas->pluck('city_name')->toArray()) }}">
                        </div>
            ...
            <div class="card shadow-sm border-0 rounded-3 mb-4">
               ...
               <div class="card-body">
                  <form action="{{ route('builder.profile.addProject') }}" method="POST" enctype="multipart/form-data" class="row g-2 mb-4 bg-light p-3 rounded">
                     @csrf
                     <div class="col-md-4">
                  ...
                  <div class="row g-3">
                     @forelse($builder->completedProjects as $cp)
                        <div class="col-md-6">
                           <div class="border rounded p-3 d-flex justify-content-between align-items-center">
                              <div>
                                 <h6 class="fw-bold mb-1">{{ $cp->project_title }}</h6>
                                 <p class="text-muted small mb-0"><i class="fas fa-map-marker-alt text-danger me-1"></i> {{ $cp->location }} | {{ $cp->area_details }}</p>
                              </div>
                              <form action="{{ route('builder.profile.deleteProject', $cp->id) }}" method="POST">
                                 @csrf
                                 @method('DELETE')
         ...
         <div class="col-md-4">
            ...
            <div class="card shadow-sm border-0 rounded-3 mb-4">
               ...
               <div class="card-body">
                  <form action="{{ route('builder.profile.addPortfolio') }}" method="POST" enctype="multipart/form-data" class="mb-4">
                     @csrf
                     <div class="mb-2">
                  ...
                  <div class="row g-2">
                     @forelse($builder->portfolios as $p)
                        <div class="col-6 position-relative">
                           <img src="{{ asset($p->image_url) }}" class="img-fluid rounded border" style="height: 100px; width: 100%; object-fit: cover;">
                           <form action="{{ route('builder.profile.deletePortfolio', $p->id) }}" method="POST" class="position-absolute top-0 end-0 m-1">
                              @csrf
                              @method('DELETE')
            ...
            <div class="card shadow-sm border-0 rounded-3">
               ...
               <div class="card-body">
                  <form action="{{ route('builder.profile.changePassword') }}" method="POST">
                     @csrf
                     <div class="mb-3">
