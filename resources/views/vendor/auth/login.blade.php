...
<html lang="en">
   <head>
      ...
      <title> {{ $settings->company_name ?? 'Vendor Panel' }} | Vendor Login</title>
      <!-- Favicon icon-->
   ...
   <body>
      ...
      <div class="container-fluid">
         <div class="row">
            <div class="col-xl-7 login_one_image"><img class="bg-img-cover bg-center" src="{{ config('app.admin_assets') }}images/login/login-bg.jpeg" alt="{{ $settings->company_name ?? 'Vendor Panel' }}"></div>
            <div class="col-xl-5 p-0"> 
               <div class="login-card login-dark login-bg">
                  <div>
                    <div><a class="logo" href=""><img style="height: 100px;width:auto;" class="img-fluid for-light m-auto" src="{{ !empty($settings->logo) ? asset($settings->logo) : '' }}" alt="{{ $settings->company_name ?? 'Vendor Panel' }}">
              <img class="for-dark" style="height: 100px;width:auto;" src="{{ !empty($settings->logo) ? asset($settings->logo) : '' }}" alt="{{ $settings->company_name ?? 'Vendor Panel' }}"></a></div>
                        ...
                        <form class="theme-form" id="loginForm">
                           ...
                           <div class="form-group">
                              ...
                              <input class="form-control" type="email" name="email" id="email" 
                                 ...
                                 value="{{ old('email', Cookie::get('email')) }}" required>
                           </div>
         ...
         <style>
         .toast-info { color: #fff !important; }
         .toast-success { color: #fff !important; }
         .toast-error { color: #fff !important; }
         </style>
         <script>
