      ...
      <!-- Products Catalog -->
         ...
         <li class="sidebar-list {{ in_array($segment_two, ['equipment', 'equipment-booking']) ? 'active' : '' }}">
            ...
            <ul class="sidebar-submenu" style="{{ in_array($segment_two, ['equipment', 'equipment-booking']) ? 'display:block;' : '' }}">
               <li><a class="{{ $segment_two == 'equipment' && $segment_three == 'list' ? 'active' : '' }}" href="{{ route('admin.equipment.list') }}"><i class="fas fa-list me-2"></i> Equipments List</a></li>
               <li><a class="{{ $segment_two == 'equipment' && $segment_three == 'add' ? 'active' : '' }}" href="{{ route('admin.equipment.add') }}"><i class="fas fa-plus-circle me-2"></i> Add Equipment</a></li>
               <li><a class="{{ $segment_two == 'equipment-booking' ? 'active' : '' }}" href="{{ route('admin.equipment-booking.list') }}"><i class="fas fa-calendar-check me-2"></i> Rental Bookings</a></li>
            </ul>
         </li>
         ...
         <li class="sidebar-list {{ in_array($segment_two, ['build-category', 'builder', 'build-inquiry']) ? 'active' : '' }}">
            ...
            <ul class="sidebar-submenu" style="{{ in_array($segment_two, ['build-category', 'builder', 'build-inquiry']) ? 'display:block;' : '' }}">
               <li><a class="{{ $segment_two == 'build-category' ? 'active' : '' }}" href="{{ route('admin.build-category.list') }}"><i class="fas fa-th-large me-2"></i> Build Categories</a></li>
               <li><a class="{{ $segment_two == 'builder' && $segment_three == 'list' ? 'active' : '' }}" href="{{ route('admin.builder.list') }}"><i class="fas fa-user-tie me-2"></i> Builders List</a></li>
               <li><a class="{{ $segment_two == 'builder' && $segment_three == 'add' ? 'active' : '' }}" href="{{ route('admin.builder.add') }}"><i class="fas fa-user-plus me-2"></i> Add Builder</a></li>
               <li><a class="{{ $segment_two == 'build-inquiry' ? 'active' : '' }}" href="{{ route('admin.build-inquiry.list') }}"><i class="fas fa-headset me-2"></i> Customer Inquiries</a></li>
            </ul>
         </li>
