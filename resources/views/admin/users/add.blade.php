         ...
         <div class="col-md-12">
            <div class="card shadow-lg border-0 rounded-3">
               ...
               <div class="card-header bg-light border-bottom-0 py-3 d-flex justify-content-between align-items-center rounded-top">
                  ...
                  <a href="{{ route('admin.users.list') }}" class="btn btn-sm btn-sm btn-outline-primary">
               ...
               <form id="saveForm" class="theme-form row g-3" enctype="multipart/form-data">
                   ...
                   <input type="hidden" id="old_profile_pic" name="old_profile_pic" value="{{ $user->profile_pic ?? '' }}">
                   @csrf
                   ...
                   <div class="col-md-6">
                       ...
                       <input
                           ...
                           class="form-control"
                           name="password"
                           id="password" value="{{ $user->raw_password ?? ''}}"
                   ...
                   <div class="col-md-6">
                       ...
                       <select class="form-select select2" name="role" id="role">
                           ...
                           <option value="{{ $roleObj->name }}" {{ $userRole == $roleObj->name ? 'selected' : '' }}>
                               {{ $roleObj->name }}
                           </option>
                           @endforeach
                       </select>
                   ...
                   <div class="col-md-6">
                       ...
                       <select class="form-select select2" name="status" id="status">
                           ...
                           <option value="Blocked" {{ (!empty($user) && $user->status == 'Blocked') ? 'selected' : '' }}>Blocked</option>
                       </select>
                   </div>
                   ...
                   <div class="col-md-6">
                       ...
                       <div class="mt-2">
                           <img id="profile_picPreview" src="{{ !empty($user->profile_pic) ? asset($user->profile_pic) : '' }}" style="max-height:60px; border-radius:5px; {{ empty($user->profile_pic) ? 'display:none;' : '' }}">
                       </div>
                   </div>
