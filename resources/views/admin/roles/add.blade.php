         ...
         <div class="col-md-12">
            <div class="card shadow-lg border-0 rounded-3">
               ...
               <div class="card-header bg-light border-bottom-0 py-3 d-flex justify-content-between align-items-center rounded-top">
                  ...
                  <a href="{{ route('admin.roles.list') }}" class="btn btn-sm btn-sm btn-outline-primary">
       ...
       $('#saveForm').on('submit', function(e){
           ...
           $.ajax({
               ...
               success:function(response){
                   toastr.success(response.message || 'Role saved successfully!');
